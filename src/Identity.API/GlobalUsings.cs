...
global using ShreyShop.Identity.API;
global using ShreyShop.Identity.API.Configuration;
global using ShreyShop.Identity.API.Data;
global using ShreyShop.Identity.API.Models;
global using ShreyShop.Identity.API.Services;
