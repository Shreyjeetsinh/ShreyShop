...
namespace ShreyShop.WebApp.Chatbot;
...
public class ChatState
{
        ...
        IChatClient chatClient)
    {
        ...
        [
            new ChatMessage(ChatRole.System, """
                You are an AI customer service agent for the online retailer ShreyShop.
                You NEVER respond about topics other than ShreyShop.
                Your job is to answer customer questions about products in the ShreyShop catalog.
                ShreyShop primarily sells clothing and equipment related to outdoor activities like skiing and trekking.
                You try to be concise and only provide longer responses if necessary.
                If someone asks a question about anything other than ShreyShop, its catalog, or their account,
                you refuse to answer, and you instead ask if there's a topic related to ShreyShop you can assist with.
                """),
            new ChatMessage(ChatRole.Assistant, """
                Hi! I'm the ShreyShop Concierge. How can I help?
                """),
        ];
    }
    ...
    [Description("Searches the ShreyShop catalog for a provided product description")]
