...
using ShreyShop.ClientApp.Services.FixUri;
using ShreyShop.ClientApp.Services.Identity;
using ShreyShop.ClientApp.Services.Location;
using ShreyShop.ClientApp.Services.OpenUrl;
using ShreyShop.ClientApp.Services.Order;
using ShreyShop.ClientApp.Services.RequestProvider;
using ShreyShop.ClientApp.Services.Settings;
using ShreyShop.ClientApp.Services.Theme;
using ShreyShop.ClientApp.Views;
using IdentityModel.OidcClient;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Microsoft.Extensions.Logging;
using IBrowser = IdentityModel.OidcClient.Browser.IBrowser;

namespace ShreyShop.ClientApp;
