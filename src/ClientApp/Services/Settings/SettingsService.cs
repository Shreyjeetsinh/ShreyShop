...
namespace ShreyShop.ClientApp.Services.Settings;
...
public class SettingsService : ISettingsService
{
    ...
    {
        await SecureStorage
            .SetAsync(UserAccessToken, userToken is not null ? JsonSerializer.Serialize(userToken, ShreyShopJsonSerializerContext.Default.UserToken) : string.Empty)
    ...
    public async Task<UserToken> GetUserTokenAsync()
    {
        ...
        return string.IsNullOrEmpty(userToken) ? default : JsonSerializer.Deserialize(userToken, ShreyShopJsonSerializerContext.Default.UserToken);
    }
