...
using ShreyShop.Basket.API.Grpc;
using ShreyShop.Basket.API.IntegrationEvents.EventHandling;
using ShreyShop.Basket.API.IntegrationEvents.EventHandling.Events;
using ShreyShop.Basket.API.Model;
using ShreyShop.Basket.UnitTests.Helpers;
using Microsoft.Extensions.Logging.Abstractions;
using Grpc.Core;
using BasketItem = ShreyShop.Basket.API.Model.BasketItem;

namespace ShreyShop.Basket.UnitTests;
...
public class BasketServiceTests
{
    ...
    public async Task UpdateBasketPersistsItemsForAuthenticatedUser()
    {
        ...
        request.Items.Add(new ShreyShop.Basket.API.Grpc.BasketItem { ProductId = 42, Quantity = 3 });
