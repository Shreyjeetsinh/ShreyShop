using ShreyShop.Ordering.API.Application.IntegrationEvents;
using ShreyShop.Ordering.Domain.AggregatesModel.OrderAggregate;

namespace ShreyShop.Ordering.UnitTests.Application;
