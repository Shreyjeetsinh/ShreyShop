using ShreyShop.WebhookClient.Services;
using ShreyShop.WebhookClient.Endpoints;
...
namespace ShreyShop.Application.UnitTests;
...
public class WebhookClientTests
{
    ...
    public async Task WebhookEndpointsValidateTokenAndPersistAcceptedPayload()
    {
        ...
        invalidCheck.Headers.Add("X-shreyshop-whtoken", "wrong");
        ...
        validCheck.Headers.Add("X-shreyshop-whtoken", "expected");
        ...
        Assert.AreEqual("expected", validCheckResponse.Headers.GetValues("X-shreyshop-whtoken").Single());
        ...
        acceptedRequest.Headers.Add("X-shreyshop-whtoken", "expected");
